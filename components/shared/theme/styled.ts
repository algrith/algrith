...
export const ThemeWrapper = styled.div` 
  ...
  ul.dropdown-wrapper {
    ${tw`absolute z-50 top-11 right-0 bg-white rounded-lg ring-1 ring-theme-primary/10 shadow-lg overflow-hidden w-40 text-lg text-slate-700 dark:text-dark-mode-octonary dark:bg-dark-mode-secondary dark:ring-0`};
